...
def clone_love_android_repository():
    subprocess.check_call('git clone --recurse-submodules --depth 1 https://github.com/love2d/love-android')
...
def patch_build_gradle():
    replacements = {
        r"applicationId 'org.love2d.android'": r"applicationId 'org.salatinee.taiko-bird'",
...
gradlew_executable = gradlew_directory / 'gradlew.bat'
